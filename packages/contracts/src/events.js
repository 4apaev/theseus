...
import {
    ...
    shipTravelRejected,
    shipRigChanged,
    shipModuleOperationRejected,
    cargoLoaded,
    cargoUnloaded,
    cargoOperationRejected,
    cargoModuleExchanged,
    cargoModuleExchangeRejected,
    tradeExecuted,
    tradeRejected,
    marketPriceChanged,
} from './schemas.js'
...
export const tree = freezer({
    ...
    ship: {
        ...
        renamed : shipRenamed.slug,
        rename  : { rejected: shipRenameRejected.slug },
        travel  : { rejected: shipTravelRejected.slug },
        rig     : { changed: shipRigChanged.slug },
        module  : { operation: { rejected: shipModuleOperationRejected.slug }},
    },
    cargo: {
        ...
        module   : {
            exchanged: cargoModuleExchanged.slug,
            exchange : { rejected: cargoModuleExchangeRejected.slug },
        },
    },
    market: {
        price: {
